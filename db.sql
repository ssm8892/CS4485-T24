...
VALUES
	('1383957937', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('lolmypassword'))))), 'Bob', 'Smith', 'bob.smith@gmail.com', '2145578734', LOAD_FILE('E:/Images/bob.jpg'), 5),
	('2021200021', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('iloveCS'))))), 'Kevin', 'Boudreaux', 'kevin.boudreaux@gmail.com', '1233457890', LOAD_FILE('E:/Images/Kevin.jpg'), 4),
    ('2021200022', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('CoolKid'))))), 'Evin', 'Jack', 'Evin.Jack@hotmail.com', '1233457891', LOAD_FILE('E:/Images/Evin.jpg'), 22),
    ('2021200023', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('IAmYourFather'))))), 'Brad', 'Owen', 'brad.owen@hotmail.com', '1233457892', LOAD_FILE('E:/Images/pic.jpg'), 12),
...
VALUES
    ...
    ('0123436280', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('HelloWorld123!!!'))))), 'Jason', 'Brim', 'Jasonbrim@utdallas.edu','2344567890', LOAD_FILE('E:/Images/Jason.jpg'), 'Nice to meet yall, I am not super new to this, I have years of experience!', 'Linear Algebra, Calculus, and Calculus 2', 'Thursday', '2:00 - 4:00', 5),
    ('589201838', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('STEMGirlzRule'))))), 'Samantha', 'Garcia', 'hellosam@gmail.com', '4752288599', LOAD_FILE('E:/Images/sam.jpg'), 'Hey y’all, I am Sam. I am a Bio Major and super excited to get to know you guys!', 'Microbiology, Modern Biology', 'Monday, Wednesday', '10:00 - 12:00, 12:00 - 2:00, 2:00 - 4:00', 45),
    ('0127455739', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('IamaRobot@'))))), 'Randy', 'Calcium', 'Radnycalcium@utdallas.edu', '2783491029', LOAD_FILE('E:/Images/Randy.jpg'), 'I am the best tutor in the whole world!', 'Intro to Physics, Databases, Organic Chemistry','Monday, Wednesday', '2:00 - 4:00, 4:00 - 6:00, 6:00 - 8:00', 16);
