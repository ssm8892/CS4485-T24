...
VALUES
	('5802759208', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('ChemGod'))))), 'Helen', 'Clyde', 'helen.cylde@yahoo.com', '4589728976', "assets/F_PROFILE.png", 'Hello, my name is Helen Clyde and I am a senior at UTD. I cannot wait to teach you guys!', 'General Chemistry, Organic Chemistry', 'Monday, Tuesday, Wednesday, Thursday', '2:00 PM - 4:00 PM, 4:00 PM - 6:00 PM', 45),
    ('0123456789', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('HelloWorld123!'))))), 'Josh', 'Burrim', 'JoshBurrim@utdallas.edu', '1234567890', "assets/avataaars.svg", 'Nice to meet yall, I am super new to this!', 'Intro to CompSCI, Data Structures', 'Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', '10:00 AM - 12:00 PM , 12:00 PM - 2:00 PM, 2:00 PM - 4:00 PM, 4:00 PM - 6:00 PM, 6:00 PM - 8:00 PM, 8:00 PM - 10:00 PM', 40),
    ('0123436280', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('HelloWorld123!!!'))))), 'Jason', 'Brim', 'Jasonbrim@utdallas.edu','2344567890', "assets/avataaars.svg", 'Nice to meet yall, I am not super new to this, I have years of experience!', 'Linear Algebra, Calculus, and Calculus 2', 'Thursday', '2:00 PM - 4:00 PM', 5),
    ('589201838', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('STEMGirlzRule'))))), 'Samantha', 'Garcia', 'hellosam@gmail.com', '4752288599', "assets/F_PROFILE.png", 'Hey y’all, I am Sam. I am a Bio Major and super excited to get to know you guys!', 'Microbiology, Modern Biology', 'Monday, Wednesday', '10:00 AM - 12:00 PM, 12:00 PM - 2:00 PM, 2:00 - 4:00', 45),
    ('0127455739', CONCAT('*', UPPER(SHA1(UNHEX(SHA1('IamaRobot@'))))), 'Randy', 'Calcium', 'Radnycalcium@utdallas.edu', '2783491029', "assets/avataaars.svg", 'I am the best tutor in the whole world!', 'Intro to Physics, Databases, Organic Chemistry','Monday, Wednesday', '2:00 PM - 4:00 PM, 4:00 PM - 6:00 PM, 6:00 PM - 8:00 PM', 16);
